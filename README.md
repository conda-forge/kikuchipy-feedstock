...
Summary: Processing, simulating, and indexing of electron backscatter diffraction (EBSD)
patterns
...
kikuchipy is a library for processing, simulation, and indexing of electron
...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/kikuchipy-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/kikuchipy-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi add kikuchipy kikuchipy-base
# for installing globally
pixi global install kikuchipy kikuchipy-base
```
...
It is possible to list all of the versions of `kikuchipy` available on your platform:
...
```
pixi search kikuchipy --channel conda-forge
```
